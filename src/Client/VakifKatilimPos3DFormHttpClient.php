...
class VakifKatilimPos3DFormHttpClient extends AbstractHttpClient
{
    /**
     * @inheritDoc
     */
    ...
    {
        return VakifKatilimPos::class === $gatewayClass && HttpClientInterface::API_NAME_GATEWAY_3D_API === $apiName;
    }
