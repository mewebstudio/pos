...
<form method="post" action="<?php echo $gateway; ?>" role="form">
    <div class="row">
        <div class="form-group col-sm-12">
            ...
            <input type="text" name="name" id="name" class="form-control input-lg" placeholder="Card Holder Number" value="John Doe">
        </div>
        <div class="form-group col-sm-12">
            <label for="number">Card Number</label>
            <input type="text" name="number" id="number" class="form-control input-lg" placeholder="Credit card number" value="4155650100416111">
        </div>
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" name="cvv" id="cvv" class="form-control input-lg" placeholder="Cvv" value="123">
        </div>
    </div>
    <hr>
