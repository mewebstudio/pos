...
if (($request->getMethod() !== 'POST' && PosInterface::TX_TYPE_PAY_POST_AUTH !== $transaction)
...
?>
    ...
    <div class="result">
        <h3 class="text-center text-<?= $pos->isSuccess() ? 'success' : 'danger'; ?>">
            <?php if (PosInterface::TX_TYPE_PAY_AUTH === $transaction || PosInterface::TX_TYPE_PAY_POST_AUTH === $transaction) : ?>
                <?= $pos->isSuccess() ? 'Payment is successful!' : 'Payment is not successful!'; ?>
            <?php elseif (PosInterface::TX_TYPE_PAY_PRE_AUTH === $transaction) : ?>
        ...
        <div class="text-right">
            <?php if ($pos->isSuccess()) : ?>
                ...
                <?php if (PosInterface::TX_TYPE_PAY_PRE_AUTH === $transaction) : ?>
                    <a href="<?= $bankTestsUrl ?>/regular/post-auth.php" class="btn btn-lg btn-primary">Finish provisioning
                        ></a>
                <?php endif; ?>
                <?php if (PosInterface::TX_TYPE_PAY_AUTH === $transaction) : ?>
