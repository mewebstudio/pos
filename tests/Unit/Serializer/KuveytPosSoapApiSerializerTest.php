...
/**
 * @covers \Mews\Pos\Serializer\KuveytPosSoapApiSerializer
 */
class KuveytPosSoapApiSerializerTest extends TestCase
{
    private KuveytPosSoapApiSerializer $serializer;

    protected function setUp(): void
    {
        parent::setUp();

        $this->serializer = new KuveytPosSoapApiSerializer();
    }

    public function testSupports(): void
    {
        $supports = $this->serializer::supports(KuveytPos::class, HttpClientInterface::API_NAME_QUERY_API);
        $this->assertTrue($supports);

        $supports = $this->serializer::supports(KuveytPos::class, HttpClientInterface::API_NAME_PAYMENT_API);
