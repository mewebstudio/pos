...
/**
 * @covers \Mews\Pos\Client\PayForPosHttpClient
...
class PayForPosHttpClientTest extends TestCase
{
    ...
    {
        $this->assertTrue(PayForPosHttpClient::supports(PayForPos::class));
        $this->assertFalse(PayForPosHttpClient::supports(AkbankPos::class));
    }
