...
/**
 * @covers \Mews\Pos\Client\PayFlexCPV4Pos3DFormHttpClient
 * @covers \Mews\Pos\Client\AbstractHttpClient
 */
class PayFlexCPV4Pos3DFormHttpClientTest extends TestCase
{
    use HttpClientTestTrait;

    private PayFlexCPV4Pos3DFormHttpClient $client;
    ...
    public function testSupports(): void
    {
        ...
        $this->assertFalse($this->client::supports(PayFlexCPV4Pos::class, HttpClientInterface::API_NAME_PAYMENT_API));
    ...
    public static function requestDataProvider(): \Generator
    {
        yield [
            ...
            'order'          => ['id' => 123],
            'expectedApiUrl' => 'https://cptest.vakifbank.com.tr/CommonPayment/api/RegisterTransaction',
        ];
    }
}
