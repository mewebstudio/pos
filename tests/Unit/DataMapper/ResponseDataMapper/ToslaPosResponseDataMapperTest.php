        ...
        return [
            'success_pay'                     => [
                ...
                'expectedData' => [
                    ...
                    'proc_return_code'  => '00',
                    'transaction_id'    => null,
                    'transaction_time'  => new \DateTimeImmutable('20240120005007'),
                    'error_message'     => null,
                    'ref_ret_num'       => null,
                    ...
                    'currency'          => 'TRY',
                    'first_amount'      => 1.01,
                    'capture_time'      => new \DateTimeImmutable('20240120005007'),
                    'cancel_time'       => null,
                    'refund_amount'     => null,
                    'refund_time'       => null,
                    'installment_count' => 0,
            ...
            'success_pre_pay_then_cancel'     => [
                ...
                'expectedData' => [
                    ...
                    'proc_return_code'  => '00',
                    'transaction_id'    => null,
                    'transaction_time'  => new \DateTimeImmutable('20231205224003'),
                    'error_message'     => null,
                    'ref_ret_num'       => null,
                    'masked_number'     => '41595600****7732',
                    ...
                    'currency'          => 'TRY',
                    'first_amount'      => 1.01,
                    'capture_time'      => new \DateTimeImmutable('20231205224003'),
                    'cancel_time'       => null,
                    'refund_amount'     => null,
                    'refund_time'       => null,
                    'installment_count' => 0,
            ...
            'success_pre_auth'                => [
                ...
                'expectedData' => [
                    ...
                    'proc_return_code'  => '00',
                    'transaction_id'    => null,
                    'transaction_time'  => new \DateTimeImmutable('20240119230959'),
                    'error_message'     => null,
                    'ref_ret_num'       => null,
                    'masked_number'     => '41595600****7732',
                    'order_status'      => 'PAYMENT_COMPLETED',
                    ...
                    'currency'          => 'TRY',
                    'first_amount'      => 1.01,
                    'capture_time'      => new \DateTimeImmutable('20240119230959'),
                    'cancel_time'       => null,
                    'refund_amount'     => null,
                    'refund_time'       => null,
                    'installment_count' => 0,
            ...
            'success_pre_auth_then_post_auth' => [
                ...
                'expectedData' => [
                    ...
                    'proc_return_code'  => '00',
                    'transaction_id'    => null,
                    'transaction_time'  => new \DateTimeImmutable('20231210132528'),
                    'error_message'     => null,
                    'ref_ret_num'       => null,
                    'masked_number'     => '41595600****7732',
                    ...
                    'currency'          => 'TRY',
                    'first_amount'      => 1.01,
                    'capture_time'      => new \DateTimeImmutable('20231210132528'),
                    'cancel_time'       => null,
                    'refund_amount'     => null,
                    'refund_time'       => null,
                    'installment_count' => 2,
            ...
            'success_pay_and_partial_refund'  => [
                ...
                'expectedData' => [
                    ...
                    'proc_return_code'  => '00',
                    'transaction_id'    => null,
                    'transaction_time'  => new \DateTimeImmutable('20240120005901'),
                    'error_message'     => null,
                    'ref_ret_num'       => null,
                    'masked_number'     => '41595600****7732',
                    ...
                    'currency'          => 'TRY',
                    'first_amount'      => 1.01,
                    'capture_time'      => new \DateTimeImmutable('20240120005901'),
                    'cancel_time'       => null,
                    'refund_amount'     => 0.59,
                    'refund_time'       => null,
                    'installment_count' => 0,
