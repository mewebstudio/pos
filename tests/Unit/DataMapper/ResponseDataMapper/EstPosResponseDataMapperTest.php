        ...
        return [
            ...
            'pay_order_status'       => [
                ...
                'expectedData' => [
                    ...
                    'status'           => 'approved',
                    'status_detail'    => 'approved',
                    'transaction_time' => new \DateTime('2024-01-03 21:37:57.259'),
            ...
            'pre_pay_order_status'   => [
                ...
                'expectedData' => [
                    ...
                    'status'           => 'approved',
                    'status_detail'    => 'approved',
                    'transaction_time' => new \DateTime('2024-01-03 21:42:35.902'),
                    'capture_time'     => null,
            ...
            'canceled_order_status'  => [
                ...
                'expectedData' => [
                    ...
                    'status'           => 'approved',
                    'status_detail'    => 'approved',
                    'transaction_time' => new \DateTime('2024-01-03 21:49:42.929'),
                ...
                'expectedData' => [
                    ...
                    'recurringOrders'           => [
                        [
                            ...
                            'status'           => 'approved',
                            'status_detail'    => 'approved',
                            'transaction_time' => new \DateTime('2022-10-30 14:58:03.449'),
                            'capture_time'     => new \DateTime('2022-10-30 14:58:03.449'),
                ...
                'expectedData' => [
                    ...
                    'transactions'     => [
                        [
                            ...
                            'capture'          => true,
                            'currency'         => null,
                            'transaction_time' => new \DateTime('2024-01-02 21:52:59.261'),
                            'capture_time'     => null,
                            'masked_number'    => null,
                        ],
                        [
                            ...
                            'status'           => 'declined',
                            'error_code'       => null,
                            'transaction_time' => new \DateTime('2024-01-02 21:53:02.486'),
                            'capture_time'     => null,
                            'masked_number'    => null,
                            'status_detail'    => 'general_error',
                            'capture'          => false,
                ...
                'expectedData' => [
                    ...
                    'transactions'     => [
                        [
                            ...
                            'capture'          => true,
                            'currency'         => null,
                            'transaction_time' => new \DateTime('2024-01-02 21:47:28.785'),
                            'capture_time'     => null,
                            'masked_number'    => null,
                        ],
                    ],
                ...
                'expectedData' => [
                    ...
                    'transactions'     => [
                        [
                            ...
                            'capture'          => true,
                            'currency'         => null,
                            'transaction_time' => new \DateTime('2024-01-01 22:15:27.511'),
                            'capture_time'     => null,
                            'masked_number'    => null,
                        ],
                    ],
                ...
                'expectedData' => [
                    ...
                    'transactions'     => [
                        [
                            ...
                            'capture'          => false,
                            'currency'         => null,
                            'transaction_time' => new \DateTime('2024-01-01 22:28:30.716'),
                            'capture_time'     => null,
                            'masked_number'    => null,
                        ],
                    ],
                ...
                'expectedData' => [
                    ...
                    'transactions'     => [
                        [
                            ...
                            'capture'          => true,
                            'currency'         => null,
                            'transaction_time' => new \DateTime('2024-01-01 22:37:53.396'),
                            'capture_time'     => null,
                            'masked_number'    => null,
                        ],
                    ],
