...
class GarantiPosTest extends TestCase
{
    ...
    public function testMap3DPaymentAuthSuccessPaymentFail()
    {
        ...
        $this->assertSame(100, $result1['amount']);
        //todo should be TRY
